...
<div class="content-wrapper" style="height: 100px;">
    ...
    <div class="card">
        ...
        <form action="upload.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="card-body">
                    ...
                    <div class="col-md-6 ">
                        <h6>Documentation: <input type="img"></h6>
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Maintenance Fee Data</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>2</td>
                        <td>
                            <a href="receipt.php?user_id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">View</a>
                        </td>
                    </tr>
                    <tr>
